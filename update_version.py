...
def main():
  ...
  CFBundleGetInfoString = FullVersionStr + ", Copyright ChrisL, " + str(today.year)
  CFBundleVersion = FullVersionStr
  
  print "update_version.py - setting version to " + FullVersionStr
  print "Updating plist version info..."
  
  plistpath = scriptpath + "/resources/FilterOne-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FilterOne-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FilterOne-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FilterOne-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FilterOne-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/FilterOne-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/FilterOne-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/FilterOne.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/FilterOne.iss",inplace=1):
